...
def render(out_path: str, score: int = 100, total: int = 124,
           stars: int = 0, benchmarks: int = 485) -> Path:
    W, H = 1200, 630
    ...
    for i, (label, big_v, sub) in enumerate(cards):
        ...
        y = 360
        # Card body
        d.rounded_rectangle([x, y, x + card_w, y + 200], radius=14,
...
def main() -> None:
    ...
    ap.add_argument("--out", default="docs/og.png",
    ...
    args = ap.parse_args()
    p = render(args.out, score=args.score, total=args.total,
