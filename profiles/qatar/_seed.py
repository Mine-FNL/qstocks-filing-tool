...
SYMBOL_SUBSECTOR: dict[str, str] = {
    "QNBK": "Commercial Bank",
    "CBQK": "Commercial Bank",
    "DHBK": "Commercial Bank",
    "ABQK": "Commercial Bank",
    "KCBK": "Commercial Bank",
    "QIBK": "Islamic Bank",
    "QIIK": "Islamic Bank",
    "MARK": "Islamic Bank",
    "DUBK": "Islamic Bank",
    "QFBQ": "Islamic Bank",
    "DBIS": "Brokerage",
    "QOIS": "Joint Investment",
    "NLCS": "Financial Holding",
    "IHGS": "Islamic Financial Services",
    "QATI": "Conventional Insurance",
    "DOHI": "Conventional Insurance",
    "QGRI": "Reinsurance",
    "QLMI": "Life & Medical Insurance",
    "AKHI": "Takaful Insurance",
    "QISI": "Takaful Insurance",
    "BEMA": "Takaful Insurance",
    "UDCD": "Diversified Real Estate",
    "BRES": "Property Development",
    "ERES": "Real Estate Holding",
    "MRDS": "Property Development",
    "IQCD": "Petrochemicals",
    "MPHC": "Petrochemicals",
    "QAMC": "Aluminium",
    "QEWS": "Utilities",
    "QNCD": "Cement & Building Materials",
    "GISS": "Oil & Gas Services",
    "QIMD": "Diversified Manufacturing",
    "QIGD": "Industrial Holding",
    "AHCS": "Diversified Conglomerate",
    "IGRD": "Diversified Holding",
    "MKDM": "Diversified Holding",
    "MHAR": "Industrial Holding",
    "SIIS": "Trading & Distribution",
    "ZHCD": "Food & Beverages",
    "WDAM": "Food Production",
    "MERS": "Supermarkets & Retail",
    "BLDN": "Food Production",
    "QFLS": "Fuel Retail",
    "MCCS": "Technology Distribution",
    "QGMD": "Medical Devices",
    "MCGS": "Healthcare Services",
    "FALH": "Education",
    "QCFS": "Media & Entertainment",
    "ORDS": "Telecom Operator",
    "VFQS": "Telecom Operator",
    "MEZA": "IT Services",
    "TQES": "IT Services",
    "QNNS": "Shipping & Marine",
    "GWCS": "Warehousing & Logistics",
    "QGTS": "LNG Shipping",
}
...
COMPANY_NAMES: dict[str, str] = {
    "QNBK": "Qatar National Bank (QNB)",
    "CBQK": "The Commercial Bank (Q.P.S.C.)",
    "DHBK": "Doha Bank",
    "ABQK": "Ahli Bank (Qatar)",
    "KCBK": "Al Khalij Commercial Bank (al khaliji)",
    "QIBK": "Qatar Islamic Bank",
    "QIIK": "Qatar International Islamic Bank",
    "MARK": "Masraf Al Rayan",
    "DUBK": "Dukhan Bank",
    "QFBQ": "Lesha Bank",
    "DBIS": "Dlala Brokerage and Investment Holding",
    "QOIS": "Qatar Oman Investment Company",
    "NLCS": "National Leasing Holding (Alijarah)",
    "IHGS": "Inma Holding",
    "QATI": "Qatar Insurance Company (QIC)",
    "DOHI": "Doha Insurance Group",
    "QGRI": "Qatar General Insurance & Reinsurance",
    "QLMI": "QLM Life & Medical Insurance",
    "AKHI": "Al Khaleej Takaful Insurance",
    "QISI": "Qatar Islamic Insurance Group",
    "BEMA": "Damaan Islamic Insurance Company (Beema)",
    "UDCD": "United Development Company",
    "BRES": "Barwa Real Estate",
    "ERES": "Ezdan Holding Group",
    "MRDS": "Mazaya Qatar Real Estate Development",
    "IQCD": "Industries Qatar",
    "MPHC": "Mesaieed Petrochemical Holding Company",
    "QAMC": "Qatar Aluminium Manufacturing Company (Qamco)",
    "QEWS": "Qatar Electricity & Water Company",
    ...
    "MKDM": "Mekdam Holding Group",
    "MHAR": "Al Mahhar Holding",
    "SIIS": "Salam International Investment",
    "ZHCD": "Zad Holding Company",
    "WDAM": "Widam Food Company",
    "MERS": "Al Meera Consumer Goods Company",
    "BLDN": "Baladna",
    "QFLS": "Qatar Fuel Company (WOQOD)",
    "MCCS": "Mannai Corporation",
    "QGMD": "Qatar German Company for Medical Devices",
    "MCGS": "Medicare Group",
    "FALH": "Al Faleh Educational Holding",
    "QCFS": "Qatar Cinema & Film Distribution",
    "ORDS": "Ooredoo",
    "VFQS": "Vodafone Qatar",
    "MEZA": "MEEZA",
    "TQES": "Estithmar Holding",
    "QNNS": "Qatar Navigation (Milaha)",
    "GWCS": "Gulf Warehousing Company (GWC)",
...
ENRICH: dict[str, dict] = {
    "QNBK": {
        ...
        "segments_expected": {
            "by_geography": ["Qatar", "Egypt", "Turkey", "Other GCC", "Europe", "Asia"],
        ...
        "events": [
            {
                "year": 2013,
                "type": "acquisition",
                "title": "Acquired majority of Alternatif Bank (Turkey)",
    ...
    "DHBK": {
        "segments_expected": {
            "by_geography": ["Qatar", "UAE", "Kuwait", "India"],
    ...
    "QIBK": {
        ...
        "segments_expected": {
            "by_geography": ["Qatar", "UK", "Lebanon"],
            "by_business": ["Corporate", "Retail", "Treasury", "Investment / Sukuk"],
        },
        "peers": ["QIIK", "MARK", "DUBK"],
        "accounting_quirks": [
            "No interest income — profit on Islamic financing",
        ...
        "events": [
            {
                "year": 2021,
                "type": "merger",
                "title": "Merger with Al Khalij Commercial Bank (al khaliji)",
    ...
    "DUBK": {
        ...
        "names": [
            {"name": "Barwa Bank", "from": None, "to": 2020},
        ...
        "events": [
            {
                "year": 2019,
                "type": "merger",
                "title": "Barwa Bank / International Bank of Qatar merger",
    ...
    "QFBQ": {
        "segments_expected": {
            "by_geography": ["Qatar", "International"],
            "by_business": ["Principal investments", "Investment banking", "Asset management"],
        },
        "names": [
            {"name": "Qatar First Bank", "from": None, "to": 2022},
        ...
        "events": [
            {
                "year": 2022,
                "type": "rename",
                "title": "Qatar First Bank → Lesha Bank",
    ...
    "IHGS": {
        ...
        "names": [
            {"name": "Islamic Holding Group", "from": None, "to": 2022},
            {"name": "Inma Holding", "from": 2022, "to": None},
        ],
    },
    "KCBK": {
        "segments_expected": {
            "by_geography": ["Qatar", "UAE"],
            "by_business": ["Wholesale", "Retail", "Treasury"],
        },
        ...
        "events": [
            {
                "year": 2021,
                "type": "merger",
                "title": "Merged into Masraf Al Rayan (MARK)",
    ...
    "ORDS": {
        ...
        "events": [
            {
                "year": 2022,
                "type": "merger",
                "title": "Indosat–Hutchison merger (Indonesia)",
        ...
        "peers": ["VFQS"],
        "accounting_quirks": [
            "Multi-currency geographic segments; FX translation is material",
            "Watch net debt / EBITDA and EBITDA margin by country",
        ],
    },
    "VFQS": {
        "segments_expected": {"by_geography": ["Qatar"], "by_business": ["Mobile", "Fixed"]},
        "peers": ["ORDS"],
    },
    "IQCD": {
        "segments_expected": {
        ...
        "events": [
            {
                "year": 2022,
                "type": "restructuring",
                "title": "Qatar Steel operations wound down",
    ...
    "QAMC": {
        "segments_expected": {"by_geography": ["Qatar"], "by_business": ["Aluminium (Qatalum JV)"]},
        "peers": ["IQCD", "MPHC"],
    ...
    "QATI": {
        ...
        "peers": ["DOHI", "QGRI"],
        "accounting_quirks": [
            "Large international book; multi-currency; watch combined ratio",
    ...
    "QGTS": {
        "reporting_currency": "QAR",
        "segments_expected": {
            "by_geography": ["International (global LNG fleet)"],
            "by_business": ["LNG shipping", "LPG / product shipping", "Vessel JVs"],
        },
        "accounting_quirks": [
            "USD-linked charter revenue; many vessel-owning JVs",
            "Hedging of interest-rate/FX on long-term charters",
        ],
    },
    "QNNS": {
        "names": [{"name": "Qatar Navigation (Milaha)", "from": None, "to": None}],
        "segments_expected": {
            "by_geography": ["Qatar", "International"],
            "by_business": [
                "Maritime & Logistics",
                "Gas & Petrochem shipping",
                "Offshore",
                "Trading",
                "Capital (investments)",
            ],
    ...
    "QFLS": {
        "segments_expected": {
            "by_geography": ["Qatar"],
            "by_business": ["Fuel retail", "Non-fuel retail (Sidra)", "Bunkering", "Transport"],
        }
    },
    "AHCS": {
        "segments_expected": {
...
ENRICH.update(
    {
        ...
        "MEZA": {
            "segments_expected": {
                "by_geography": ["Qatar"],
                "by_business": ["Managed IT services", "Data centres", "Cloud & cybersecurity"],
            },
            "events": [
                {
                    "year": 2023,
                    "type": "ipo",
                    "title": "IPO / QSE listing",
        ...
        "TQES": {
            "segments_expected": {
                "by_geography": ["Qatar", "International"],
                "by_business": ["Healthcare", "Services", "Contracting", "Ventures (hospitality)"],
            }
        },
        "GWCS": {
            "segments_expected": {
