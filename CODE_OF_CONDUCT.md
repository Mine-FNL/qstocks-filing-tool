...
personal appearance, or other identity attributes.
...
defined and clarified by project leaders.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior
may be reported to the community leaders responsible for enforcement
at **[security@mine-fnl.example](mailto:security@mine-fnl.example)**
(see [`SECURITY.md`](SECURITY.md) for the same contact used for
vulnerability reports). All complaints will be reviewed and
...
[FAQ][faq]. Translations are available at the [Contributor Covenant i18n
project][i18n].
...
[i18n]: https://www.contributor-covenant.org/translations